...
const TestForm = ({ setResult }) => {
  ...
  const questionsPerPage = 4; // Changed from 5 to 4
  ...
  return (
    <form onSubmit={handleSubmit} className="h-full flex flex-col">
      ...
      {/* Current questions with numbers - Now showing 4 per page */}
                  ...
                  <div className="mt-2">
                    {key === "Age" ? (
                      <input
                        ...
                        min={0}
                        max={120}
                        className="border border-gray-300 rounded px-3 py-2 w-32 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    ) : key === "Gender" ? (
                      <select
                        name={key}
                        value={formData[key]}
                        onChange={handleChange}
                        className="border border-gray-300 rounded px-3 py-2 w-full max-w-xs focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
